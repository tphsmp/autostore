...
public class Main {
    public static void main(String[] args) throws TooBigCarException {
        ...
        Mercedes mercedes = new Mercedes("Mercedes E190", 1000000, 1200, 17000, 3500);
        Mercedes mercedes2 = new Mercedes("Mercedes s350", 5000000, 1800, 2000, 4500);
        Mercedes mercedes3 = new Mercedes("Mercedes e550", 3500000, 1300, 2200, 3800);
        ...
        Pontiak pontiak3 = new Pontiak("Pontiak Dragonfly", 150000, 1000, 800, 1800);
        Kandibobr kandibobr = new Kandibobr("Kandibobr TYR", 2000000, 1200, 1900, 4000);
